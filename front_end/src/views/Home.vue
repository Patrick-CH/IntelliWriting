          ...
          <li class="entry1">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">品味经典，学习最新最热的政策时评</p>
              </div>
            </router-link>
          </li>
          <li class="entry2">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">进入创作中心，体验AI创作乐趣与便捷</p>
              </div>
            </router-link>
          </li>
          <li class="entry3">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">查看历史纪录，以史为鉴，成就匠心之作</p>
              </div>
            </router-link>
          </li>
          <li class="entry4">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">还不知道怎么使用？快看看吧！</p>
              </div>
            </router-link>
          </li>
          <li class="entry5">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">有更多想法和意见？来联系我们吧！</p>
              </div>
            </router-link>
          </li>
          <li class="entry5">
            ...
            >
              <div class="case-item-hover">
                <p class="hover-title">更多内容敬请期待！</p>
              </div>
            </router-link>
          </li>
        </ul>
