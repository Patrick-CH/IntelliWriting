...
def set_args():
    ...
    parser.add_argument('--test_file_path', default='data/dev.json', type=str, help='新闻标题生成的测试数据')
    parser.add_argument('--pretrained_model_path', default='trained_model/model0', type=str, help='预训练的GPT2模型的路径')
